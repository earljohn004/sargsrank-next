...
DROP TYPE IF EXISTS public.approval_status_enum CASCADE;

DROP TYPE IF EXISTS public.game_player_status_enum CASCADE;
...
CREATE TYPE public.approval_status_enum AS ENUM ('PENDING', 'ACCEPTED', 'DECLINED');

CREATE TYPE public.game_player_status_enum AS ENUM ('LOSE', 'WIN', 'DRAW', 'INIT');
...
CREATE TABLE public.game_players (
    ...
    approval_status public.approval_status_enum DEFAULT 'PENDING',
    declined_reason TEXT NULL DEFAULT '' :: TEXT,
    CONSTRAINT fk_game_players_game_id FOREIGN KEY (game_id) REFERENCES public.game_information (game_id) ON DELETE CASCADE,
    CONSTRAINT fk_game_players_player_id FOREIGN KEY (player_id) REFERENCES public.player_information (player_id) ON DELETE CASCADE,
...
create table public.game_scores (
    ...
    status public.game_player_status_enum not null default 'INIT',
    updated_at timestamp with time zone not null default now(),
    CONSTRAINT fk_game_scores_game_id FOREIGN KEY (game_id) REFERENCES public.game_information (game_id) ON DELETE CASCADE,
    CONSTRAINT fk_game_scores_player_id FOREIGN KEY (player_id) REFERENCES public.player_information (player_id) ON DELETE CASCADE,
